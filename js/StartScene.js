class StartScene extends Phaser.Scene {
    ...
    updateTexts(width, height) {
        ...
        if (this.introductionButton) this.introductionButton.destroy();
        ...
        // ── BOTÓN START GAME → ahora va a NombreScene ─────────
        ...
        // ── BOTÓN RANKING ─────────────────────────────────────
        this.rankingButton = this.add.text(width / 2, height * 0.63, "Ranking", {
        ...
        // ── BOTÓN GUIDE ───────────────────────────────────────
        this.introductionButton = this.add.text(width / 2, height * 0.76, "Guide", {
            fontSize: Math.min(width * 0.03, 22) + 'px',
            fill: '#eee3cf',
            fontFamily: '"Press Start 2P"',
            backgroundColor: '#282a1d',
