	class BaseNivelScene extends Phaser.Scene {
        	...
        	super(key);
        	this.config = config; // Aquí guardamos qué fondo, qué villano y qué preguntas usar
	    }
		...
		const questions = this.config.questions; // Usa las preguntas pasadas por config
